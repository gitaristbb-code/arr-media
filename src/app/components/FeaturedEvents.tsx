...
export function FeaturedEvents() {
  ...
  return (
    <section
      id="events"
      className="bg-[#2B2B2B] py-32 text-white overflow-hidden relative"
    >
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          >
            ...
            <p className="text-gray-400 text-lg font-medium">
              Почувствуйте атмосферу и масштаб наших проектов. Ознакомьтесь с
              мероприятиями, которые мы успешно реализовали.
            </p>
          </motion.div>
          <motion.button
            initial={{ opacity: 0, x: 30 }}
