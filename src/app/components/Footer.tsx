...
export function Footer() {
  return (
    <footer id="contact" className="bg-[#1A1A1A] text-white py-24 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 font-medium max-w-sm mb-8 leading-relaxed">
              Организуем мероприятия любого масштаба под ключ: от корпоративных конференций до масштабных фестивалей, обеспечивая безупречный продакшн.
            </p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 font-medium">
              <li><a href="#" className="text-gray-400 hover:text-[#00B4B4] transition-colors">О нас</a></li>
              <li><a href="#" className="text-gray-400 hover:text-[#00B4B4] transition-colors">Услуги</a></li>
              <li><a href="#events" className="text-gray-400 hover:text-[#00B4B4] transition-colors">Проекты</a></li>
              <li><a href="#contact" className="text-gray-400 hover:text-[#00B4B4] transition-colors">Контакты</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between text-gray-500 text-sm font-medium">
          <p>&copy; {new Date().getFullYear()} ARR Media Event Production. Все права защищены.</p>
